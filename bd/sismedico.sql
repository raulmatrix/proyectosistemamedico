...
CREATE TABLE IF NOT EXISTS 'reserva' (
  ...
  UNIQUE KEY ('Medico_idMedico', 'Horarios_idHorarios'),
  KEY 'fk_Reserva_Usuario1_idx' ('Usuario_idUsuario'),
  KEY 'fk_Reserva_Medico1_idx' ('Medico_idMedico'),
  KEY 'fk_Reserva_Horarios1_idx' ('Horarios_idHorarios'),
  CONSTRAINT 'fk_Reserva_Horarios1' FOREIGN KEY ('Horarios_idHorarios') REFERENCES 'sismedico'.'horarios' ('idHorarios') ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT 'fk_Reserva_Medico1' FOREIGN KEY ('Medico_idMedico') REFERENCES 'sismedico'.'medico' ('idMedico') ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT 'fk_Reserva_Usuario1' FOREIGN KEY ('Usuario_idUsuario') REFERENCES 'sismedico'.'usuario' ('idUsuario') ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;