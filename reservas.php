...
$sql2 = "SELECT 
    ...
    u.apellidoPat AS ApellidoPaternoUsuario,
    u.apellidoMat AS ApellidoMaternoUsuario,
    m.nombreMed AS NombreMedico,
    m.apellidoPat AS ApellidoPaternoMedico,
    m.apellidoMat AS ApellidoMaternoMedico,
    m.especialidad AS EspecialidadMedico,
    r.fecha AS FechaReserva,
    r.horario AS HorarioReserva,
    r.estado AS EstadoReserva
FROM 
    reserva r
JOIN 
    medico m ON r.Medico_idMedico = m.idMedico
JOIN 
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Reservas de fichas pacientes</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                      ...
                      <?php
                        while($fila = mysqli_fetch_assoc($resultado)){
                            echo "<tr>";
                                ...
                                echo "<td>".$fila['ApellidoPaternoUsuario']."</td>";
                                echo "<td>".$fila['ApellidoMaternoUsuario']."</td>";
                                echo "<td>".$fila['EspecialidadMedico']."</td>";
                                ...
                                echo "<td>";
                                  ...
                                  echo " ";*/
                                  echo "<button type='button' class='btn btn-danger' data-toggle='modal' data-target='#eliminarMed' onClick='quitarMed()'><i class='fas fa-trash'></i></button>";
                                echo "</td>";
